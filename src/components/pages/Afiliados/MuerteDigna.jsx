...
const DIMENSIONES_DERECHO = [
  {
    ...
    icon: 'CP',    titulo: 'Cuidados Paliativos (Ley 1733 de 2014)',
  ...
  },
  {
    ...
    icon: 'AT',    titulo: 'Adecuación / Retiro de Esfuerzo Terapéutico',
  ...
  {
    id: 'eutanasia-medica',
    icon: 'EA',    titulo: 'Eutanasia Activa (Res. 971 de 2021)',
  ...
  },
  {
    ...
    icon: 'SMA',    titulo: 'Suicidio Médicamente Asistido (SMA)',
  ...
  return (
    <section className="page page--afiliados-sub">
      ...
      <div className="triage-info-box">
        <div className="triage-info-box__icon" aria-hidden="true">MC</div>        <div>
      ...
      <div className="canales-ayuda">
        <div className="canales-ayuda__icon" aria-hidden="true">C</div>        <div>
